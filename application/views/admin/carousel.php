        ...
        <span id="solmsg" class="text-success"></span><br>
          <form id="addcarousal" role="form" class="mt-2" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter title 1" id="title" name="title">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Enter title 2</label>
              <input type="text" class="form-control" placeholder="Enter title 2" id="title2" name="title2">
            </div>
