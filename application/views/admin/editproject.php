...
<div class="padding">
  ...
  <div class="p-x-xs">
    ...
    <?php foreach ($home_projects as $ceo): ?>
      <label class="col-sm-2 form-control-label">Project Name</label>
      <div class="col-sm-6">
        <input type="text" name="projetname" class="form-control rounded" value="<?= $ceo['project_name']; ?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="pricestart" class="form-control rounded" value="<?= $ceo['price']; ?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" name="projectdescripition" rows="5" value="<?= $ceo['project_descripition']; ?>"></textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name="no_bed" id="input-id-1" value="<?= $ceo['bedroom']; ?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="no_bathroom" class="form-control rounded" value="<?= $ceo['bathroom']; ?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="no_square"  class="form-control rounded" value="<?= $ceo['squarefeet']; ?>">
      </div>
    </div>
